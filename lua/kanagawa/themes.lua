...
return {
    ...
    wave = function(palette)
        return {
            ...
            syn = {
                string     = palette.myText,
                variable   = palette.myText,
                number     = palette.myText,
                constant   = palette.myText,
                identifier = palette.myText,
                -- parameter  = "#C3B1B1",
                -- parameter  = "#B1ADC8",
                -- parameter  = "#b8b4d0",
                parameter  = palette.myText,
                -- parameter = "#d5a4a6",
                -- parameter  = "#C8ADAD",
                -- parameter  = "#d7a8a8",
                fun        = palette.myText,
                statement  = palette.myText,
                keyword    = palette.myText,
                operator   = palette.myText,
                preproc    = palette.myText,
                type       = palette.myText,
                regex      = palette.myText,
                deprecated = palette.myText,
                comment    = palette.myText,
                punct      = palette.myText,
                special1   = palette.myText,
                special2   = palette.myText,
                special3   = palette.myText,
            },
            vcs = {
